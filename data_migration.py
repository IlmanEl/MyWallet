...
- date: дата в формате "YYYY-MM-DD" (если не указана явно, используй текущую дату)
- project: название проекта, если упоминается (например "3D модели", "AI agent")

Особенности:
- "минус" или знак "-" означает расход (expense)
- "плюс" или "+" означает доход (income)
- Суммы типа "15 000" = 15000
- Если сумма передается кому-то (например "15 000 халису") - это расход
